...
class EditStoreViewModel : ViewModel() {
    ...
    private val showFab = MutableLiveData<Boolean>() //Show / hide FloatingActionButtom
    private val result =
        MutableLiveData<Any>() //Determine if it is an update (Boolean) or a discharge (StoreEntity)
